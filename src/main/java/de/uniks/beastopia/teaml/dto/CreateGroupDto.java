...
public class CreateGroupDto
{
   ...
   public CreateGroupDto setName(String value)
   {
      this.name = value;
      return this;
   }
   ...
   public CreateGroupDto withMembers(User value)
   {
   ...
   public CreateGroupDto withMembers(Collection<? extends User> value)
   {
      if (this.members == null)
      {
   ...
   public CreateGroupDto withoutMembers(User value)
   {
   ...
   public CreateGroupDto withoutMembers(Collection<? extends User> value)
   {
      if (this.members != null)
      {
