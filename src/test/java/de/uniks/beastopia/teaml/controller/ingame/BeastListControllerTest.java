...
class BeastListControllerTest extends ApplicationTest {
    ...
    public void start(Stage stage) throws Exception {
        ...
        when(cache.getTrainer()).thenReturn(new Trainer(null, null, "TRAINER_ID", null, null, null, null, null, List.of(), 0, "", 0, 0, 0, new NPCInfo(false, false, false, false, 3, List.of(), List.of())));
        app.start(stage);
